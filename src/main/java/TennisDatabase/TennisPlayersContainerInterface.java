...
// Interface (package-private) providing the specifications for the TennisDatabase.TennisPlayersContainer class.
interface TennisPlayersContainerInterface {

   // Desc.: Insert a TennisDatabase.TennisPlayer object (reference) into this container.
   // Input: A TennisDatabase.TennisPlayer object (reference).
